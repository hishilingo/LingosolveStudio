    ...
    public class PDFConvert
    {
        ...
        private bool Convert(string inputFile, string outputFile, bool throwException, string options)
        {
            ...
            if (string.IsNullOrEmpty(inputFile))
            {
                ...
                {
                    MessageBox.Show("The inputfile is missing.");
                    return false;
                }
            }
            if (!System.IO.File.Exists(inputFile))
            {
                ...
                {
                    MessageBox.Show(string.Format("The file '{0}' doesn't exist.", inputFile));
                    return false;
                }
            }
            if (string.IsNullOrEmpty(_sDeviceFormat))
            {
                ...
                {
                    MessageBox.Show("You didn't provide a device for the conversion.");
                    return false;
                }
            }
            ...
            try
            {
                ...
                if (intReturn < 0)
                {
                    ...
                    {
                        MessageBox.Show(GSDLL_INSTANCE);
                        return false;
                    }
                }
            }
            ...
            {//in this case the dll we r using isn't the dll we expect
                ...
                {
                    MessageBox.Show(GSDLL_NOT_FOUND);
                    return false;
                }
            }
